...
def parameters():
    ...
    return {
        ...
        "AeroTEM (2007)": {
            ...
            "tx_offsets": [[0, 0, 0]],
            "bird_offset": [0, 0, -40],
            "comment": "normalization accounts for 2.5m radius loop * 8 turns "
            "* 69 A current, nanoTesla",
        ...
        "GENESIS (2014)": {
            ...
            "tx_offsets": [[-90, 0, -43]],
            "bird_offset": [-90, 0, -43],
            "comment": "normalization accounts for unit dipole moment at the "
            "tx_offset, in part-per-million",
            "normalization": "ppm",
            "tx_specs": {"type": "VMD", "a": 1.0, "I": 1.0},
            "data_type": "Bz",
        },
        ...
        "HELITEM2 (25C, 7.5Hz)": {
            ...
            "comment": "normalization accounts for a loop 961 m**2 area * 4 turns "
            "* 146 A current, nanoTesla",
        ...
        "Zonge 8Hz": {
            ...
            "tx_offsets": [[0, 0, 0]],
            "bird_offset": [0, 0, 0],
            "comment": "normalization accounts for 100 m square loop (converted to circular), "
            "unit current, in micro-V",
